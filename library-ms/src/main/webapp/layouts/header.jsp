  ...
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #aa29f5; color: white;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" >
      ...
      <ul class="navbar-nav mr-auto" >
	    ...
	    <li class="nav-item active">
	      <a class="nav-link" href="/books" style="margin-right: 350px;">Books </a>
	    </li>
        <li class="nav-item active">
          <a class="btn btn-success" href="/signup" style="margin-right: 10px;">Sign Up </a>
        </li>
        <li class="nav-item active">
          <a class="btn btn-primary" href="/login" style="margin-right: 10px;">Login </a>
        </li>
        <li class="nav-item active">
          <a class="btn btn-warning" href="/admin-login" style="margin-right: 10px;">Admin Login </a>
        </li>    
      </ul>
